    ...
    >
      ...
      >
        ...
        >
          ...
          <p className="text-sm mt-1" style={{ color: "var(--faarz-text-muted)" }}>
            Admin Dashboard
          </p>
        </motion.div>
        ...
        <form className="space-y-5" onSubmit={(e) => e.preventDefault()}>
          <div>
            <label className="text-xs font-medium mb-1.5 block" style={{ color: "var(--faarz-text-secondary)" }}>
              Email
            </label>
          ...
          <motion.button
            ...
            style={{
              background: "linear-gradient(135deg, var(--faarz-green), var(--faarz-accent))",
              color: "#0a0f0d",
            }}
          >
            Sign In
          ...
          <div className="flex items-center gap-3 my-2">
            ...
            <span className="text-xs" style={{ color: "var(--faarz-text-muted)" }}>or</span>
            <div className="flex-1 h-px" style={{ background: "var(--faarz-border)" }} />
          </div>
          ...
          >
            <svg width="18" height="18" viewBox="0 0 24 24">
              <path fill="#EA4335" d="M5.26,9.76A7.49,7.49,0,0,1,12,4.5a6.88,6.88,0,0,1,4.86,1.89l3.6-3.6A12,12,0,0,0,12,.5,11.99,11.99,0,0,0,1.24,6.65Z" />
              <path fill="#34A853" d="M16.04,18.01A7.07,7.07,0,0,1,12,19.5a7.49,7.49,0,0,1-6.74-5.26l-4.02,3.11A11.99,11.99,0,0,0,12,23.5a11.45,11.45,0,0,0,7.84-3.04Z" />
              <path fill="#4A90D9" d="M19.84,20.46A11.81,11.81,0,0,0,23.5,12a10.85,10.85,0,0,0-.25-2.5H12v5h6.47a5.74,5.74,0,0,1-2.43,3.51Z" />
              <path fill="#FBBC05" d="M5.26,14.24A7.42,7.42,0,0,1,4.5,12a7.42,7.42,0,0,1,.76-2.24L1.24,6.65A11.94,11.94,0,0,0,0,12a11.94,11.94,0,0,0,1.24,5.35Z" />
            </svg>
